...
export default function PersonalPortfolioProject() {
  ...
  const content = {
    en: {
      ...
      description:
        "This is my personal portfolio website built with Next.js, TypeScript, and Tailwind CSS. It serves as a comprehensive showcase of my projects, skills, academic background, and interests. The website features bilingual support (English/Chinese), responsive design for all devices, elegant UI/UX, and detailed project pages. It includes a contact form integrated with Resend API for email delivery, a photo gallery powered by Cloudinary for image storage and management, and an admin interface for photo uploads. The site demonstrates my full-stack development capabilities, API integrations, and modern web development practices.",
      ...
      featuresList: [
        ...
        "Contact Form: Integrated with Resend API for reliable email delivery",
        "Photo Gallery: Cloudinary-powered image storage and display with admin upload interface",
    ...
    zh: {
      ...
      description:
        "這是我的個人作品集網站，使用 Next.js、TypeScript 和 Tailwind CSS 構建。它作為一個全面的展示平台，展示我的專案、技能、學術背景和興趣。網站具有中英文雙語支援、響應式設計、優雅的 UI/UX 和詳細的專案頁面。網站整合了 Resend API 實現聯絡表單的郵件發送功能，使用 Cloudinary 進行照片儲存和管理，並提供管理介面用於照片上傳。它展示了我的全端開發能力、API 整合能力和現代網頁開發實踐。",
      features: "核心功能",
      featuresList: [
        "雙語支援：無縫切換中英文",
        "響應式設計：針對桌面、平板和手機優化",
        "專案展示：每個專案的詳細頁面，包含截圖和描述",
        "聯絡表單：整合 Resend API 實現可靠的郵件發送功能",
        "照片畫廊：使用 Cloudinary 進行圖片儲存和顯示，提供管理介面用於照片上傳",
